<?php
	...
	function getData($conn, $result, $params) {
		...
		//get emp
		$sql = "SELECT emp_scg_emp_id,emp_user_id, emp_th_firstname+' '+emp_th_lastname + ' (' + emp_en_firstname + ' ' + emp_en_lastname + ')' as 'emp_fullname',LOWER(emp_email_bus) AS emp_email_bus ,emp_th_div+'/'+emp_th_dept+'/'+emp_th_sec as 'emp_dept',emp_th_firstname+' '+emp_th_lastname+'/'+emp_th_div+'/'+emp_th_dept+'/'+emp_th_sec as 'emp_fullnamedept' FROM emp_mstr WHERE emp_status_code  = '3'";
