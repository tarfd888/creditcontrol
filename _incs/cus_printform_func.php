...
function print_formnewcust($cus_app_nbr,$savefile,$output_folder,$cr_output_filename,$conn,$watermark_text) {
	...
	$params = array($cus_app_nbr);
	$sql_cr= "SELECT * FROM cr_book_mstr WHERE (book_app_nbr = ?) order by book_id";
	...
	$params = array($cus_app_nbr);
	$query_cr = "SELECT * FROM  cr_app_mstr WHERE  cr_app_nbr = ?";
	$result = sqlsrv_query($conn, $query_cr, $params, array("Scrollable" => 'keyset' ));
	$rowCounts = sqlsrv_num_rows($result);
	if($rowCounts > 0){
		while($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC))
		{
			...
			$cr_mgr_app_date = mssql_escape(dmytx($row['cr_mgr_app_date']));
			if($cr_mgr_status=="A"){
				$mgr_status_app = "<font color='green'>*** Approved *** <font>";
				
			}
			if($cr_bankrupt  == '1'){
				$chk_bank_dom = '<img src="../_images/check_true.png" width=10px>';
				$chk_bank_exp = '<img src="../_images/check_blank.png" width=10px>';
			}
			else {
				$chk_bank_exp = '<img src="../_images/check_true.png" width=10px>';
				$chk_bank_dom = '<img src="../_images/check_blank.png" width=10px>';
			}
		}
	} 
	...
	else
	{
		...
		"<table width=100% border=0 style='border-collapse: collapse; font-size:7pt'>".
			...
			"<tr>". 
				"<td align=center style='font-size:7pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=20% height=20>...................................................</td>".
				"<td align=center style='font-size:7pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=20% height=20>$mgr_status_app</td>".
				"<td align=center style='font-size:7pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=20% height=20>$status_app_array[0]</td>".
			"</tr>".
			"<tr>".
				"<td align=center style='font-size:6.5pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=20% height=20>$cusd_is_sale1_name<br><br></td>".
...
function print_formchgcust($cus_app_nbr,$savefile,$output_folder,$cr_output_filename,$conn,$watermark_text) {
	...
	$params_chg = array($cus_app_nbr);
	$query_chg = "SELECT * FROM  cr_app_mstr WHERE  cr_app_nbr = ?";
	$result_chg = sqlsrv_query($conn, $query_chg, $params_chg, array("Scrollable" => 'keyset' ));
	$rowCounts = sqlsrv_num_rows($result_chg);
	if($rowCounts > 0){
		while($row = sqlsrv_fetch_array($result_chg, SQLSRV_FETCH_ASSOC))
		{
			$cr_bankrupt = mssql_escape($row['cr_bankrupt']);
			$cr_remark = mssql_escape($row['cr_remark']);
	...
	$body=
		"<table width=100% border=1 style='border-collapse: collapse; cellpadding='5' cellspacing='0' font-size:7pt'>".
			"<tr>".
				"<td colspan='4' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>". 
			"<tr>".
				"<td colspan='4' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; รหัสลูกค้า : $cus_code &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; วันที่ขออนุมัติ : $cus_date &nbsp;</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>เอกสารเลขที่ : $cus_app_nbr &nbsp;</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=15>&nbsp; เลขประจำตัวผู้เสียภาษี (Tax ID No.) / เลขที่ทะเบียนพาณิชย์ : $cus_tax_id</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=20>&nbsp; ข้อมูลเดิม </td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; ชื่อลูกค้า : $cus_code_name</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=15>&nbsp; ที่อยู่ : $cus_address</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=20>&nbsp; ข้อมูลที่ขอเปลี่ยนแปลง </td>".
			"</tr>".
			"<tr>".
				...
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkbox4 เปลี่ยนแปลงที่อยู่จดทะเบียน </td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				...
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkbox6 ยกเลิก Code ลูกค้า </td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:1px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; ข้อมูลใหม่ </td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; ชื่อลูกค้า : $cus_reg_nme</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px dotted;' width=25% height=15>&nbsp; ที่อยู่ : $address</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=15>&nbsp; วันที่เริ่มใช้ : $cus_effective_date</td>".
			"</tr>".

			"<tr>".
				"<td colspan='4' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=20>&nbsp; เอกสารประกอบการพิจารณา</td>".
				"<td colspan='4' align=left style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15></td>".
			"</tr>".
			"<tr>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkArray[0] $bookArray[0]</td>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkArray[1] $bookArray[1]</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkArray[2] $bookArray[2]</td>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkArray[3] $bookArray[3]</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkArray[4] $bookArray[4]</td>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkArray[5] $bookArray[5]</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkArray[6] $bookArray[6]</td>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; $chkArray[7] $bookArray[7]</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=15>&nbsp; $chkArray[8] $bookArray[8]</td>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=15>&nbsp; $chkArray[9] $bookArray[9]</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=20>&nbsp; เหตุผลในการเปลี่ยนแปลง / ยกเลิก</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=20>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -  $cusd_sale_reason &nbsp;</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=15>&nbsp; สถานะลูกค้า ณ วันที่ : $cr_cus_chk_date &nbsp;</td>".
			"</tr>".
			"<tr>".
				...
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=15>&nbsp; วันที่ครบกำหนดชำระเงินล่าสุด : $cr_due_date &nbsp;</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=20>&nbsp; บันทึกเกี่ยวกับภาระค้ำประกัน : &nbsp;</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=20>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -  $cr_rem_guarantee &nbsp;</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=20>&nbsp; อื่น ๆ : &nbsp;</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=20>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -  $cr_rem_other &nbsp;</td>".
			"</tr>".
			"<tr>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px dotted; width=25% height=15'>&nbsp;ผู้เสนอ : $cusd_is_sale1_name &nbsp;</td>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px dotted; width=25% height=15'>&nbsp;Email : $cusd_is_sale1_email &nbsp;&nbsp;&nbsp;&nbsp;เบอร์โทร : $cusd_is_sale1_tel</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px dotted; width=25% height=15'>&nbsp;ชื่อผู้แทนขาย (Inside Sale) : $cusd_is_sale2_name &nbsp;</td>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px dotted; width=25% height=15'>&nbsp;Email : $cusd_is_sale2_email &nbsp;&nbsp;&nbsp;&nbsp;เบอร์โทร : $cusd_is_sale2_tel</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px dotted; width=25% height=15'>&nbsp;ชื่อผู้แทนขาย (Outside Sale) : $cusd_os_sale_name &nbsp;</td>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:0px dotted; width=25% height=15'>&nbsp;Email : $cusd_os_sale_email &nbsp;&nbsp;&nbsp;&nbsp;เบอร์โทร : $cusd_os_sale_tel</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:1px solid;border-right:0px solid;border-top:0px solid;border-bottom:1px solid;; width=25% height=15'>&nbsp;ชื่อผู้จัดการ : $cusd_sale_manager_name &nbsp;</td>".
				"<td colspan='2' align=left style='font-size:7pt;border-left:0px solid;border-right:0px solid;border-top:0px solid;border-bottom:1px solid;; width=25% height=15'>&nbsp;Email : $cusd_is_sale2_email &nbsp;&nbsp;&nbsp;&nbsp;ตำแหน่ง : $cusd_mgr_pos</td>".
				"<td colspan='4' align=right style='font-size:7pt;border-left:0px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=5></td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=25% height=20>&nbsp; ความเห็นสินเชื่อ : &nbsp;</td>".
			"</tr>".
			"<tr>".
				"<td colspan='8' align=left style='font-size:7pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=25% height=20>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -  $cr_remark &nbsp;</td>".
			"</tr>".
		"</table>"; 
	$pdf->WriteHTML($body);
