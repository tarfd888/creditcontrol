...
function printpageform_rev($crstm_nbr,$savefile,$output_folder,$cr_output_filename,$conn) {	
...
$curMonth = date('Y-m'); 
	...
	$params = array($crstm_nbr);
	 ...
	 $query_detail = "SELECT crstm_mstr.crstm_nbr, crstm_mstr.crstm_date, crstm_mstr.crstm_user, crstm_mstr.crstm_tel, crstm_mstr.crstm_cus_nbr, crstm_mstr.crstm_cus_name, crstm_mstr.crstm_tax_nbr3, ".
					 ...
					 " crstm_email_app1, crstm_email_app2, crstm_email_app3, crstm_reviewer_date, crstm_stamp_app1_date, crstm_stamp_app2_date, crstm_stamp_app3_date, crstm_fin_app_date,crstm_reviewer, crstm_reviewer2, ".
                     " crstm_mstr.crstm_chk_rearward, cus_mstr.cus_terms_paymnt, term_mstr.term_desc, cus_mstr.cus_acc_group, emp_mstr.emp_th_firstname, emp_mstr.emp_th_lastname,crstm_mstr.crstm_scgc ".
	...
	if ($rec_cus) {
		...
		if ($crstm_reviewer_date != "") { $approve_reviewer = "*** Approved ***"; }
	...
	switch ($crstm_approve) {
		...
		case "กจก. อนุมัติ":
			...
			if (inlist("60",$crstm_step_code)) { $approve1 = "*** Approved ***"; }
			$crstm_stamp_app1_date = $crstm_stamp_app1_date;
 ...
 */ 		"<table width=100% border=1 style='border-collapse: collapse; font-size:8pt'>".
	...
	$data_detail= 
		"<tr>".   
				...
				"<td align=right style='font-size:6.5pt' height=20>".number_format($sum_ord)."</td>".	
		"</tr>";
	...
	"<table width=100% border=0 style='border-collapse: collapse; font-size:8pt'>".
			...
			"<tr>".   
				...
				"<td align=right style='font-size:8pt;border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=20% height=20>$crstm_pj_amt</td>".
			...
			"<tr>".   
				...
				"<td align=right style='font-size:8pt;border-left:1px solid;border-right:1px solid;border-top:1px solid;border-bottom:1px solid;' width=20% height=20>$crstm_pj1_amt</td>".
		...
		while($row_cr = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC))
			{
				...
				}else if($chk_name=="ORD") {
					$tot_ord = $row_cr['tbl1_amt_loc_curr'];	
				}else if($chk_name=="Overdue") {
	...
	$body6_detail=
		...
		"</tr>". 
		"<tr>".
				"<td align=right style='font-size:11pt;border-left:1px solid;border-right:1px solid;border-top:1px solid;border-bottom:1px solid dotted;' width=20% height=30>$crstm_ins</td>".
				"<td align=right style='font-size:11pt;border-left:0px solid;border-right:1px solid;border-top:1px solid;border-bottom:1px solid;' width=20% height=30>".number_format($tot_bg)."</td>".
				"<td align=right style='font-size:11pt;border-left:0px solid;border-right:1px solid;border-top:1px solid;border-bottom:1px solid;' width=20% height=30>".number_format($tot_cc)."</td>".
				"<td align=right style='font-size:11pt;border-left:0px solid;border-right:1px solid;border-top:1px solid;border-bottom:1px solid;' height=30>".number_format($tot_ar+$tot_ord)."</td>".
				"<td align=right style='font-size:11pt;border-left:0px solid;border-right:1px solid;border-top:1px solid;border-bottom:1px solid;' height=30>".$t5_tot."</td>".
				"<td align=right style='font-size:11pt;border-left:0px solid;border-right:1px solid;border-top:1px solid;border-bottom:1px solid;' height=30>".number_format($tot_ord)."</td>".
				"<td align=right style='font-size:11pt;border-left:0px solid;border-right:1px solid;border-top:1px solid;border-bottom:1px solid;' height=30>".number_format($tot_ar)."</td>".
				"<td align=right style='font-size:11pt;border-left:0px solid;border-right:1px solid;border-top:1px solid;border-bottom:1px solid;' height=30>".$tot_ovr."</td>".
...
if($cus_acc_group=="ZC01" || $cus_acc_group=="ZC07" ) {
			...
			"<table><tr><td calpan=10 width=100%></td></tr></table>".
				/* "<table width=100% border=0 style='border-collapse: collapse; font-size:8pt'>".
					...
					"</tr>".
					"<tr>".
						"<td align=center style='font-size:6.5pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=20% height=20>ศุภิสรา  เชาวนาสถาพร<br><br></td>".
						"<td align=center style='font-size:6.5pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=20% height=20>ผลาทิพย์  เติมสุขนิรันดร<br><brtd>".
						"<td align=center style='font-size:6.5pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:0px solid;' width=20% height=20>นุชนารถ  วุฑฒินันท์<br><br></td>".
					"</tr>".
					"<tr>".
						"<td align=center style='font-size:6.5pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=20% height=20>เจ้าหน้าที่สินเชื่อ ( วันที่  $curdate )</td>".
						"<td align=center style='font-size:6.5pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=20% height=20>เจ้าหน้าที่สินเชื่อ (  วันที่ $curdate )</td>".
						"<td align=center style='font-size:6.5pt; border-left:1px solid;border-right:1px solid;border-top:0px solid;border-bottom:1px solid;' width=20% height=20>Finance & Credit Manager ( วันที่ $curdate )</td>".
					"</tr>".
...
///// ฟอร์มลูกค้าใหม่
function printpageform_new_rev($crstm_nbr,$savefile,$output_folder,$cr_output_filename,$conn) {	
date_default_timezone_set('Asia/Bangkok');
$curdate = date("d/m/Y");	
	...
	$query_detail = "SELECT crstm_mstr.crstm_nbr, crstm_mstr.crstm_date, crstm_mstr.crstm_user, crstm_mstr.crstm_tel, crstm_mstr.crstm_cus_nbr, crstm_mstr.crstm_cus_name, crstm_mstr.crstm_tax_nbr3, ".
                      ...
                      "crstm_mstr.crstm_stamp_app2, crstm_mstr.crstm_stamp_app2_date, crstm_mstr.crstm_fin_app_date, crstm_mstr.crstm_fin_app_by, crstm_mstr.crstm_scgc ".
