						...
						<div class="row breadcrumbs-top">
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="../crctrlbof/aradd.php"> หน่วยงานสินเชื่อ</a></li>
								</ol>
							</div>
						</div>
					</div>               
												...
												<div class="form-body">		
													...
													<div class="row">
														...
														<div class="col-md-4">
															...
															<div class="form-group">
																<input type="text" class="form-control phone-inputmask form-control input-sm font-small-3" id="phone_mask" name="phone_mask" placeholder="ระบุหมายเลขโทรศัพท์" />
															</div>
														</div>
													</div>
													<!-- End  Sales Register   -->
														...
														<div class="col-md-4">
															<div class="form-group">
																<label class="font-weight-bold">รหัสลูกค้า :<font class="text text-danger font-weight-bold"> *</font></label>
																	<? if($cr_cust_code !="") {?>	
																		<input type="text" id="cr_cust_code" name ="cr_cust_code" value="<?php echo $cr_cust_code ?>" class="form-control input-sm font-small-3" placeholder="พิมพ์ชื่อ หรือ รหัสลูกค้า" required disabled>
																	<?php } 
																	else { ?>
												...
												<?php } ?>
														...
														<div class="col-md-6">
															<div class="card">
																<div class="card-header">
																	<class="card-title"><h6>สถานะวงเงินและหนี้ ณ วันที่ :  <?echo $curdate; ?></h6>
															...
															<div class="col-md-6">
																<div class="card">
																	<div class="card-header">
																		<class="card-title"><h6>ประวัติการซื้อสินค้า 12 เดือนที่ผ่านมา ณ วันที่  <?echo $curdate; ?></h6>
																			<a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
																			<!--<div class="heading-elements">
																				<ul class="list-inline mb-0">
													...
													<?php } ?>
															...
															<div class="cus_display" style="display:none;">
																<div class="row">
																	<div class="col-md-3">
																		<input type="radio"  id="cusold_conf_yes" name="chk_rdo" value="0">
																		<label class="font-weight-bold" for="cusold_conf_yes"> ปรับเพิ่มวงเงิน</label>
																	</div>	
																	<div class="col-md-3">
																		<input type="radio"  id="cusold1_conf_yes" name="chk_rdo" value="1" >
																		<label class=" font-weight-bold" for="cusold_conf_yes"> ปรับลดวงเงิน</label>
																	</div>
																	<div class="col-md-3">
																		<input type="radio"  id="cusold2_conf_yes" name="chk_rdo" value="2"  >
																		<label class=" font-weight-bold" for="cusold_conf_yes"> ต่ออายุวงเงิน</label>
																	</div>
																</div>
															</div>
															
															<div class="cusold_display" style="display:none;">
																<div class="form-group row">
																	<!--<div class="col-3">
																		<li><a href='#div_frm_cc_add' data-toggle='modal'><i class="fa fa-plus"></i> Add</a></li>
																	</div>
																<div class="col-3">
																		<input type="text" id="txt_cc" name="txt_cc" class="form-control input-sm font-small-3" disabled>
																	</div>
																	<div class="col-4">
																		<div class="input-group input-group-sm">
																			<input id="beg_date" name="beg_date" class="form-control input-sm border-warning " type="text" placeholder="เลือกวันเริ่มใช้งาน">
																	...
																	<div class="col-4">
																		<div class="input-group input-group-sm">
																			<input id="end_date" name="end_date" class="form-control input-sm border-warning " type="text" placeholder="เลือกวันสิ้นสุด">
																				<div class="input-group-prepend">
																					<span class="input-group-text">
																						<span class="fa fa-calendar-o"></span>
																					</span>
																	...
																	<div class="col-4">
																		<div class="input-group input-group-sm">
																			<input id="cc_amt" name="cc_amt" class="form-control input-sm border-warning " type="text" style="color:red;text-align:right" onkeypress="return chkNumber_dot(event)">
																				<div class="input-group-prepend">
																					<span class="input-group-append">
																						<span class="btn btn-success"><i class="fa fa-check-square-o"></i></span>
																					</span>
																				</div>
																		</div>
																	</div>-->
															...
															<div class="term_display" style="display:none;">
																<div class="row">
																	...
																	<div class="col-3">
																		<input type="text" id="terms_paymnt" name="terms_paymnt" class="form-control input-sm font-small-3" disabled>
																	</div>
																	<div class="col-3">
																		<fieldset>
															...
															<div class="chg_term_display" style="display:none;">
																<div class="row">
																	...
																	<div class="col-3">
																		<input type="text" id="terms_paymnt1" name="terms_paymnt1" class="form-control input-sm font-small-3" disabled>
																	</div>
																	<div class="col-3">
																		<fieldset>
															...
															<div class="form-group row">
																...
																<div class="col-md-3">
																	<a title="ระบุเป็นจำนวนเลข"><input type="text" id="crstm_sd_per_mm" class="form-control input-sm " name="crstm_sd_per_mm" style="color:blue;text-align:right" onkeypress="return chkNumber_dot(event)" ></a>
																</div>
															...
															<div class="col-sm-9">
																<div class="card">
																	<div class="card-block">
																		<div class="table-responsive" style="padding:0px 15px 50px 20px;">
																			<!-- Start Datatables -->
																			<table id="tb_ord" class="table table-sm table-hover table-bordered compact nowrap" style="width:100%;" > <!--dt-responsive nowrap-->
																				...
																				<tbody>
																					<?
																						$params = array($cr_cust_code);
																						$sql_cc= "SELECT crlimit_acc, sum(crlimit_amt_loc_curr) as amt_loc, crlimit_doc_date,crlimit_due_date,crlimit_txt_ref FROM crlimit_mstr WHERE(crlimit_acc = ? and crlimit_ref = 'CC') ".
																						         "GROUP BY crlimit_acc, crlimit_doc_date,crlimit_due_date,crlimit_txt_ref order by crlimit_doc_date,crlimit_due_date";
														...
														<? if ($cus_acc_group == "DREP") {
															...
															<div class="row">
																<div class="col-md-12">
																	<div class="form-group row">
																		<label class="col-md-4 label-control font-weight-bold" for="userinput1">อำนาจดำเนินการขออนุมัติวงเงิน:</label>
																		<div class="col-md-4">
																			<input type="text" name="crstm_approve" id="crstm_approve" value="<?php echo $crstm_approve ?>" class="form-control input-sm" disabled >
																...
																<div class="col-md-12">
																	<fieldset class="form-group">
																		...
																		<textarea  name="crstm_sd_reson" id="crstm_sd_reson" class="form-control input-sm font-small-3" id="placeTextarea" rows="5" style="line-height:1.5rem;"></textarea>
																	</fieldset>	
																</div>
															</div>
															...
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group row">
																		...
																		<div class="col-md-9">
																			<input type="text" id="crstm_pj1_name" class="form-control input-sm" name="crstm_pj1_name">
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-6">
																	<div class="form-group row">
																		...
																		<div class="col-md-9">
																			<a title="ระบุเป็นจำนวนเลข"><input type="text" id="crstm_pj_amt" class="form-control input-sm" name="crstm_pj_amt" style="color:black;text-align:right" onkeypress="return chkNumber_dot(event)" ></a>
																		</div>
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="form-group row">
																		<label class="col-md-3 label-control" for="userinput1">มูลค่างาน (บาท):</label>
																		<div class="col-md-9">
																			<a title="ระบุเป็นจำนวนเลข"><input type="text" id="crstm_pj1_amt" class="form-control input-sm" name="crstm_pj1_amt" style="color:black;text-align:right" onkeypress="return chkNumber_dot(event)"></a>
																		</div>
																	</div>
																</div>
																<div class="col-md-6">
																...
																<div class="col-md-6">
																	<div class="form-group row">
																		...
																		<div class="col-md-9">
																			<div class="input-group input-group-sm">
																				<input id="crstm_pj_beg" name="crstm_pj_beg" class="form-control input-sm border-warning " type="text" placeholder="เลือกวันเริ่มใช้งาน">
																				<div class="input-group-prepend">
																					<span class="input-group-text">
																						<span class="fa fa-calendar-o"></span>
																					</span>
																...
																<div class="col-md-6">	
																	<div class="form-group row">
																		...
																		<div class="col-md-9">
																			<div class="input-group input-group-sm">
																				<input id="crstm_pj1_beg" name="crstm_pj1_beg" class="form-control input-sm border-warning " type="text" placeholder="เลือกวันเริ่มใช้งาน">
																				<div class="input-group-prepend">
																					<span class="input-group-text">
																						<span class="fa fa-calendar-o"></span>
																					</span>
														...
														<!-- End Form Body -->	
															...
															<div class="form-group row mt-n3"> 
																<div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
																	...
																	<? if($cus_nbr !="") {?>	
																		<button type="button"  id="btnsave" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1"><i class="fa fa-check-square-o"></i> Save</button>
																	...
																	<?php } 
																		...
																		<button type="submit" id="display_yes" class="btn btn-success glow mb-1 mb-sm-0 mr-0 mr-sm-1" > แสดงข้อมูลลูกค้า</button>
																	<?php } ?>
																</div>
															</div>
				...
				$(document).ready(function() {
					...
					$('input[type="radio"]').click(function() {
						if($(this).attr('id') == 'cus_conf_yes') {
							...
							$('.cusold_display').show();   
							$("#div_frm_cc_add").modal("show");
							
							$("#txt_cc").prop("required", true);
							$("#txt_cc").val("เสนอขอปรับวงเงิน");
							//$("#beg_date").prop("required", true);
							$("#beg_date").val("");
