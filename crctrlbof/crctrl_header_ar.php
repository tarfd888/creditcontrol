	<h4 class="form-section text-info mt-n2" ><i class="fa fa-cube"></i> 2. สำหรับหน่วยงานสินเชื่อ ( 1 )</h4>	
				...
				<div class="col-lg-12 ">
					<div class="row pr-1 pl-1 ">
						<?php 
							...
							if ($r_row) {
								$crstm_pre_yy = $r_row['tbl_yy_desc'];
							}			
						?>		
						<div class="col-lg-5 col-md-6 pt-1 font-weight-bold">ปีก่อน :</div>
						<div class="col-lg-7 col-md-6 pt-1 border-bottom"><? echo $crstm_pre_yy; ?></div>
					</div>	
					<div class="row pr-1 pl-1 ">
						<div class="col-lg-5 col-md-6 pt-1 font-weight-bold">% ตรงเวลา  :</div>
						<div class="col-lg-7 col-md-6 pt-1 border-bottom"><? echo $crstm_otd_pct; ?></div>
					</div>		
					<div class="row pr-1 pl-1 ">
						<div class="col-lg-5 col-md-6 pt-1 font-weight-bold">ส่วนใหญ่ล่าช้าไม่เกิน  :</div>
						<div class="col-lg-7 col-md-6 pt-1 border-bottom"><? echo $crstm_ovr_due; ?>  วัน</div>
					</div>
					<div class="row pr-1 pl-1 ">
						<div class="col-lg-5 col-md-6 pt-1 font-weight-bold">อื่น ๆ (ถ้ามี)   :</div>
						<div class="col-lg-7 col-md-6 pt-1 border-bottom"><? echo $crstm_etc; ?></div>
					</div>
					<div class="row pr-1 pl-1 ">
						<div class="col-lg-5 col-md-6 pt-1 font-weight-bold">Insurance:</div>
						<div class="col-lg-7 col-md-6 pt-1 border-bottom"><? echo $crstm_ins; ?></div>
					</div>
		...
		<div class="col-lg-6 mt-n1">
			<div class="row p-1">
				<div class="col-lg-12">
					...
					<div class="row pr-1 pl-1 ">
						<?php 
							$params = array($crstm_cur_yy);
							$sql_doc = "SELECT tbl_yy_code, tbl_yy_desc FROM tbl_yy where tbl_yy_desc = ?";
							$result = sqlsrv_query($conn, $sql_doc, $params);	
							$r_row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC);		
							if ($r_row) {
								$crstm_cur_yy = $r_row['tbl_yy_desc'];
							}			
						?>		
						<div class="col-lg-5 col-md-6 pt-1 font-weight-bold">ปีล่าสุด :</div>
						<div class="col-lg-7 pt-1 border-bottom"><? echo $crstm_cur_yy; ?></div>
					</div>		
					<div class="row pr-1 pl-1 ">
						<div class="col-lg-5 col-md-6 pt-1 font-weight-bold">% ตรงเวลา  :</div>
						<div class="col-lg-7 col-md-6 pt-1 border-bottom"><? echo $crstm_otd1_pct; ?></div>
					</div>		
					<div class="row pr-1 pl-1 ">
						<div class="col-lg-5 col-md-6 pt-1 font-weight-bold">ส่วนใหญ่ล่าช้าไม่เกิน  :</div>
						<div class="col-lg-7 col-md-6 pt-1 border-bottom"><? echo $crstm_ovr1_due; ?>  วัน</div>
					</div>
					<div class="row pr-1 pl-1 ">
						<div class="col-lg-5 col-md-6 pt-1 font-weight-bold">อื่น ๆ (ถ้ามี)   :</div>
						<div class="col-lg-7 col-md-6 pt-1 border-bottom"><? echo $crstm_etc1; ?></div>
					</div>
				</div>
			</div>
		</div>
...
<?php if($crstm_mgr_reson !="") { ?>
	<div class="row">	
		<div class="col-md-12">
			...
			<div class="col-md-2">
				<input type="radio"  id="mgr_conf_yes" name="mgr_conf" value="1" disabled <?php if($crstm_mgr_rdo=='1'){ echo "checked"; }?>>
			...
			<div class="col-md-2">
				<input type="radio"  id="mgr_conf_no" name="mgr_conf" value="2" disabled <?php if($crstm_mgr_rdo=='2'){ echo "checked"; }?>>
				...
				<div class="form-group row">
					...
					<div class="col-md-9">
						<a href="<?php echo($ImgCr3) ?>" target="_blank" id="linkcurrent_ImgProject1">
							<img src="<?php echo($ImgCr3_icon) ?>" border="0" id="ImgCr3" name="ImgCr3"  width="60" height="60">
						</a>	
					</div>
				</div>
			</div>-->
