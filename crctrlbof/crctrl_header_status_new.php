	...
	<div class="row ml-1 mr-1 pb-2 mt-n2">
	  ...
	  <div class="col-lg-6 mt-n1">
	    <div class="row p-1 ">
	      <div class="col-lg-12 ">
	        <div class="row pr-1 pl-1 ">
	          <div class="col-lg-4 col-md-6 pt-1 font-weight-bold">คณะกรรมการบริหารอนุมัติ :</div>
	          <div class="col-lg-8 col-md-6 pt-1 border-bottom">
	            <? echo $app2_name; ?>
	          </div>
	        </div>
	  ...
	  <div class="col-lg-6 mt-n1">
	    <div class="row p-1 ">
	      <div class="col-lg-12 ">
	        <div class="row pr-1 pl-1 ">
	          <div class="col-lg-4 col-md-6 pt-1 font-weight-bold">เอกสารลงนามคณะกรรมการบริหาร :</div>
	          <div class="col-lg-8 col-md-6 pt-1 border-bottom">
	            <? echo $app2_name; ?>
	          </div>
	        </div>
