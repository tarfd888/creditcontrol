...
$expire=0;
setcookie ("crnew_approve_mail", $sessionid_enc,$expire,$ck_path,$ck_dom,$ck_secure,$ck_httponly);
//
clearstatcache();
...
<head>
    ...
    <script type="text/javascript">
		$(document).ready(function () {  
			...
			$.ajax({
				type: 'POST',
				//url: '../serverside/crctrlsubmitpost.php',
				url: '../serverside/cr_approve_new_post.php',
