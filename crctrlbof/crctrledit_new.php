...
include("chkauthcrctrl.php");
	...
	"crstm_reviewer,crstm_reviewer2,crstm_noreviewer, crstm_mstr.crstm_scgc,crstm_email_app1,crstm_email_app2,crstm_email_app3 ".
...
<html class="loading" lang="en" data-textdirection="ltr">
	...
	<body class="vertical-layout vertical-menu 2-columns menu-collapsed  fixed-navbar" data-open="hover" data-menu="vertical-menu" data-col="2-columns">
									...
									<div class="card-header mt-1 pt-0 pb-0" >
										...
										<div class="heading-elements">
											<ul class="list-inline mb-0"> 
												<?php if($can_editing) { ?>
													<li><a href="../crctrlbof/crctrladd_new.php"><i class="fa fa-plus"></i> เพิ่มใบขออนุมัติวงเงินสินเชื่อลูกค้าใหม่</a></li>
												<?php } ?>
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group row">
																...
																<div class="col-md-6">
																	<input type="text" name="crstm_approve" id="crstm_approve" value="<?php echo $crstm_approve ?>" class="form-control input-sm font-small-3">
																</div>
															</div>
														</div>
														...
														<div class="col-md-6">
															<div class="form-group row">
																<div class="col-md-1">
																	...
																	<?} else { ?>
																		<input type="checkbox" class="form-control input-sm border-warning " name="crstm_noreviewer" id="crstm_noreviewer" <?php if ($crstm_noreviewer==true){ echo "checked"; }?> value="false">
																	<?}?>
																</div>
														...
														<div class="col-md-6">
															<div class="form-group row">
																...
																<div class="col-md-6">
																	<a title="ระบุเป็นจำนวนเลข"><input type="text" id="crstm_sd_per_mm" class="form-control input-sm " name="crstm_sd_per_mm" value="<?php echo $crstm_sd_per_mm ?>" style="color:blue;text-align:right" onkeyup="format(this)" onchange="format(this)" ></a>
																</div>
															</div>
														</div>
													</div>
													<div class="row">
														...
														<div class="col-md-6">
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" name="crstm_pj_name" id="crstm_pj_name" value="<?php echo $crstm_pj_name ?>" class="form-control input-sm">
																</div>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" id="crstm_pj1_name" class="form-control input-sm" name="crstm_pj1_name" value="<?php echo $crstm_pj1_name ?>">
																</div>
															</div>
														</div>
														...
														<div class="col-md-6">
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<a title="ระบุเป็นจำนวนเลข"><input type="text" id="crstm_pj_amt" value="<?php echo($crstm_pj_amt) ?>" class="form-control input-sm" name="crstm_pj_amt" style="color:black;text-align:right" onkeyup="format(this)" onchange="format(this)" ></a>
																</div>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">มูลค่างาน (บาท):</label>
																<div class="col-md-9">
																	<a title="ระบุเป็นจำนวนเลข"><input type="text" id="crstm_pj1_amt" value="<?php echo($crstm_pj1_amt) ?>" class="form-control input-sm" name="crstm_pj1_amt" style="color:black;text-align:right" onkeyup="format(this)" onchange="format(this)"></a>
																</div>
															</div>
														</div>
														<div class="col-md-6">
														...
														<div class="col-md-6">
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<div class="input-group input-group-sm">
																		<input id="crstm_pj_beg" name="crstm_pj_beg" value="<?php echo $crstm_pj_beg ?>" class="form-control input-sm border-warning font-small-3" type="text" placeholder="--- เลือกวันเริ่มใช้งาน ---">
																		<div class="input-group-prepend">
																			<span class="input-group-text">
														...
														<div class="col-md-6">	
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<div class="input-group input-group-sm">
																		<input id="crstm_pj1_beg" name="crstm_pj1_beg" value="<?php echo $crstm_pj1_beg ?>" class="form-control input-sm border-warning font-small-3" type="text" placeholder="--- เลือกวันเริ่มใช้งาน ---">
																		<div class="input-group-prepend">
																			<span class="input-group-text">
																				<span class="fa fa-calendar-o"></span>
																			</span>
															...
															<div class="card-body  my-gallery" itemscope itemtype="http://schema.org/ImageGallery">		
																...
																<?php if(($iscan_display_c3)) { ?> 
																	...
																	<!--<div class="col-md-6">
																		...
																		<label>Select File</label>
																		<label id="projectinput8" class="file center-block">
																		<input type="file" accept="" name="load_mgr_img" id="load_mgr_img" value="<?php echo $crstm_mgr_img ?>" >
																		<input type="hidden" name="crstm_mgr_img" id="crstm_mgr_img" value="<?php echo $crstm_mgr_img ?>">										
																		<span class="file-custom"></span>
																		</label>
																		</div>
																		</div>
															...
															<div class="form-group row mt-n3"> 
																<div class="col-12 d-flex flex-sm-row flex-column justify-content-end btn-group-sm mt-1">
																	<?php if(inlist($user_role,"SALE_VIEW")) { ?>
																		<button type="button" id="btnsave" name="btnsave" class="btn btn-outline-success btn-min-width btn-glow mr-1 mb-1" onclick="Swalappform('frm_edit','<?php echo encrypt($crstm_step_code, $key);?>','<?php echo $crstm_nbr; ?>','<?php echo $crstm_cus_name; ?>')"><i class="fa fa-check-square-o"></i> Save</button>
																		<?php if($reviewer_code == "110") { ?>
																			<button type="button" id="btnsave" name="btnsave" class="btn btn-outline-warning btn-min-width btn-glow mr-1 mb-1" onclick="Swalappformsend('<?php echo encrypt($reviewer_code, $key);?>','<?php echo $crstm_nbr; ?>','<?php echo $crstm_cus_name; ?>')"><i class="fa fa-envelope-o"></i> Submit110</button>
																		<? } else { ?>	
																			<?php if($crstm_sd_reson !="") { ?> <!-- case แก้ไข ---->
																				<button type="button" id="btnsave" name="btnsave" class="btn btn-outline-primary btn-min-width btn-glow mr-1 mb-1" onclick="Swalappformsend_cr('frm_send_cr1','<?php echo encrypt($reviewer_code, $key);?>','<?php echo $crstm_nbr; ?>','<?php echo $crstm_cus_name; ?>')"><i class="fa fa-envelope-o"></i> Submit10</button>
																			<?php } ?>
																		<? } ?>		
																	<?php } ?>
																	<?php if($iscan_editing_c1) { ?>
																		<?php if($crstm_cc1_reson != "") {?>
																			<button type="button" id="btnsave" name="btnsave" class="btn btn-outline-primary btn-min-width btn-glow mr-1 mb-1" onclick="Swalappformsend_cr('frm_send_cr1','<?php echo encrypt('20', $key);?>','<?php echo $crstm_nbr; ?>','<?php echo $crstm_cus_name; ?>')"><i class="fa fa-envelope-o"></i> Submit1</button>
																		<?php } ?>
																		<button type="button" id="btnsave" name="btnsave" class="btn btn-outline-success btn-min-width btn-glow mr-1 mb-1" onclick="Swalappform('frm_edit','<?php echo encrypt($crstm_step_code, $key);?>','<?php echo $crstm_nbr; ?>','<?php echo $crstm_cus_name; ?>')"><i class="fa fa-check-square-o"></i> Save1</button>
																	...
																	<?php if($iscan_editing_c2) { ?>
																		<?php if($crstm_cc2_reson != "") {?>
																			<button type="button" id="btnsave" name="btnsave" class="btn btn-outline-primary btn-min-width btn-glow mr-1 mb-1" onclick="Swalappformsend_cr('frm_send_cr1','<?php echo encrypt('30', $key);?>','<?php echo $crstm_nbr; ?>','<?php echo $crstm_cus_name; ?>')"><i class="fa fa-envelope-o"></i> Submit2</button>
																		<?php } ?>
																		<button type="button" id="btnsave" name="btnsave" class="btn btn-outline-success btn-min-width btn-glow mr-1 mb-1" onclick="Swalappform('frm_edit','<?php echo encrypt($crstm_step_code, $key);?>','<?php echo $crstm_nbr; ?>','<?php echo $crstm_cus_name; ?>')"><i class="fa fa-check-square-o"></i> Save2</button>
																	...
																	<?php if($iscan_editing_c3) { ?>
																		<?php if($crstm_mgr_reson != "" && $crstm_reviewer2 !="") {?>
																			<button type="button"  id="btnsavecr" class="btn btn-outline-info btn-min-width btn-glow mr-1 mb-1" onclick="SwalappformSend_reviewer2('<?php echo encrypt('220', $key); ?>','<?php echo $crstm_nbr; ?>','<?php echo $crstm_cus_name; ?>')"><i class="fa fa-envelope-o"></i> Submit</button>
																		<?php } ?>
																		<?php if($crstm_mgr_reson != "" && $crstm_reviewer2 =="") {?>
																			<button type="button"  id="btnsavecr" class="btn btn-outline-primary btn-min-width btn-glow mr-1 mb-1" onclick="SwalappformSend_app('frm_send_approve','<?php echo encrypt('40', $key); ?>','<?php echo $crstm_nbr; ?>','<?php echo $crstm_cus_name; ?>')"><i class="fa fa-envelope-o"></i> Submit</button>
																		<?php } ?>
		...
		$(document).ready(function(){
			...
			function Swalappformsend(chk_action,crstm_nbr,cus_name) {
				//alert(chk_action+"--"+crstm_nbr+"--"+cus_name);
				Swal.fire({
			...
			function SwalappformSend_reviewer2(chk_action,crstm_nbr,cus_name) {
				//alert(chk_action+"--"+crstm_nbr+"--"+cus_name);
				Swal.fire({
					//title: "Are you sure?",
					...
					preConfirm: function() {
						return new Promise(function(resolve) {
							...
							$.ajax({
								...
								url: '../serverside/crctrlsubmitpost_pdf_rev2.php?step_code='+chk_action  ,
								data: formData,
								timeout: 100000,
								error: function(xhr, error) {
									showmsg('[' + xhr + '] ' + error);
			...
			$("#cc_amt1").on("change", function () {
				...
				xhttp.onload = function() {
					...
					document.getElementById("app3_name").innerHTML = myObj.app3_name;
					...
					email_app3 = document.getElementById("crstm_email_app3").innerHTML = myObj.email3;
					$("#crstm_email_app1").val(email_app1);
					$("#crstm_email_app2").val(email_app2);
					$("#crstm_email_app3").val(email_app3);
