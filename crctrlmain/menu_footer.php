...
<footer class="footer footer-static footer-light navbar-border">
  <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span
      class="float-md-left d-block d-md-inline-block text-bold-600">Copyright &copy; 2022 <a class="text-bold-600 blue"
        href="https://scgceramics.com/" target="_blank">SCG CERAMICS PUBLIC CO.,LTD.</a>,</span><span
