							...
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title" id="basic-layout-icons" ><font color="1E90FF">Upload Open Order Master</font></h4>
									...
									<div class="card-content collpase show">
										<div class="card-body">
											<div class="card-block">
												...
												<form name="frmimport" id="frmimport"  class="form" action="importdata_opord.php" method="post" enctype="multipart/form-data" onsubmit="return CheckValidFile()">
													<div class="form-body">
														...
														<div class="form-group">
															...
															<label id="projectinput7" class="file center-block">
																...
																<input type="file" accept=".xlsx, .xls" name="ord_data" id="ord_data" onchange="checkTypeFile(this);">
...
<script type="text/javascript" language="javascript">
	function checkTypeFile(sender) {
		...
		function CheckValidFile() {
			var validExts = new Array(".xlsx", ".xls");
			var fileVal = document.getElementById('ord_data').value;
