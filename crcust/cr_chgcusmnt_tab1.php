        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="position-relative has-icon-left">
                        <input type="text" class="form-control input-sm font-small-2" id="cr_debt" name="cr_debt" style="color:blue;text-align:right" onkeyup="format(this)">
                            <div class="form-control-position">
                                <i class="ft-message-square"></i>
                            </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="position-relative has-icon-left">
                        <input type="text" class="form-control input-sm font-small-2" id="cr_due_date" name="cr_due_date">
                            <div class="form-control-position">
                                <i class="ft-message-square"></i>
                            </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="position-relative has-icon-left">
                        <input type="text" class="form-control input-sm font-small-2" id="cr_so_amt" name="cr_so_amt" style="color:blue;text-align:right" onkeyup="format(this)">
                            <div class="form-control-position">
                                <i class="ft-message-square"></i>
                            </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="position-relative has-icon-left">
                        <input type="text" class="form-control input-sm font-small-2" id="cr_odue_amt" name="cr_odue_amt" style="color:blue;text-align:right" onkeyup="format(this)">
                            <div class="form-control-position">
                                <i class="ft-message-square"></i>
                            </div>
                    </div>
