    ...
    <fieldset>
                ...
                <div class="col-md-3">
                    <div class="form-group ">
                        ...
                        <select data-placeholder="เลือกประเภทการขออนุมัติ"
                            ...
                            <option value="C"><?php echo 'Completed';?></option>
                            <option value="I"><?php echo 'Incomplete';?></option>
                        </select>
                    </div>
                </div>
                <div class="col-md-9">
                    ...
                    <textarea name="cr_sta_rem" id="cr_sta_rem"
                        ...
                        style="line-height:0.5rem;"></textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <?php if (inlist($user_role,'FinCR Mgr')) { ?>
                ...
                <div class="col-md-3 skin skin-square">
                    <div class="form-group">
                        <input type="radio" name="cr_mgr_status" id="cus_tg_cust11" value="">
                ...
                <div class="col-md-3 skin skin-square">
                    <div class="form-group">
                        <input type="radio" name="cr_mgr_status" id="cus_tg_cust22" value="">
