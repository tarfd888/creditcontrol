...
<script src="../_libs/js/script-cr.js?v<?php echo rand(); ?>"></script>    <!-- script master -->
<!-- <script src="../_libs/js/script-change.js?v<?php echo rand(); ?>"></script>  -->  <!-- script for chgcusmnt.php -->
