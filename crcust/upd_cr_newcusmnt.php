...
if($rowCounts > 0){
	while($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC))
	{
        ...
        $cr_whocanread = html_clear($row['cr_whocanread']);
        ...
        <div class="content-header row mt-n1">
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    <button class="btn btn-outline-info btn-min-width btn-glow dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-settings mr-1"></i>Action</button>
            ...
            <div class="card-header ">
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                        <li><a href='../newcust/newcust_list.php'><i class="fa fa-reply-all"></i></a></li>
            ...
            <div class="card-content">
                <div class="card-body">
                    <form id="frm_cust_add" name="frm_cust_add" autocomplete=OFF method="POST"
                        ...
                        <input type="hidden" name="cr_whocanread" value="<?php echo $cr_whocanread ?>">
                        ...
                        <input type="hidden" name="cus_step_code"  value="<?php echo encrypt($cus_step_code, $key)?>">
                        ...
                        <div class="tab-content px-1 pt-1 font-small-2">
                            ...
                            <div role="tabpanel" class="tab-pane <?php echo $active; ?>" id="activeIcon22"
                                ...
                                <?php include("upd_cr_newcusmnt_tab1.php"); ?>
                            ...
                            <div class="tab-pane <?php echo $active; ?>" id="profileIcon22" role="tabpanel"
                                ...
                                <?php include("upd_cr_newcusmnt_tab2.php"); ?>
                            ...
                            <div class="form-actions right _showBtnSave" style="display:show">
                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end btn-group-sm">
                                    ...
                                    <button type="button" id="btnsave_cr" name="btnsave_cr" 
