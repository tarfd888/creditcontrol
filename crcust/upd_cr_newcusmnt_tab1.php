...
<fieldset>
    <div class="bs-callout-success callout-border-left callout-bordered callout-transparent mt-1 p-1">    
        ...
        <div class="row skin skin-square">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input type="radio" name="cus_tg_cust" id="cus_tg_cust2" disabled value="exp" <?php if($cus_tg_cust=='exp'){ echo "checked"; }?>>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="position-relative has-icon-left">
                        <input type="text" class="form-control input-sm font-small-2" id="cr_sap_code" name="cr_sap_code" value="<?php echo $cr_sap_code ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="position-relative has-icon-left">
                        <input type="text" class="form-control input-sm font-small-2" id="cr_sap_code_date" name="cr_sap_code_date" value="<?php echo $cr_sap_code_date ?>">
                            <div class="form-control-position">
                                <i class="ft-message-square"></i>
                            </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="position-relative has-icon-left">
                        <input type="text" class="form-control input-sm font-small-2" id="cr_date_of_reg" name="cr_date_of_reg" value="<?php echo $cr_date_of_reg ?>">
                            <div class="form-control-position">
                                <i class="ft-message-square"></i>
                            </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="position-relative has-icon-left">
                        <input type="text" class="form-control input-sm font-small-2" id="cr_reg_capital" name="cr_reg_capital" style="color:blue;text-align:right" onkeyup="format(this)"
                                onchange="format(this)" value="<?php echo $cr_reg_capital ?>">
                            <div class="form-control-position">
                                <i class="ft-message-square"></i>
                            </div>
                    </div>
    ...
    <div class="bs-callout-success callout-border-right callout-bordered callout-transparent mt-1 p-1">    
        ...
        <div class="row">
            <div class="col-md-4 skin skin-square">
                <div class="form-group">
                    <input type="radio" name="cr_bankrupt" id="cr_bankrupt[]" value="1" <?php if($cr_bankrupt=="1"){ echo "checked"; }?>>
                    <label for="cr_bankrupt">ปกติ</label>
                </div>
            </div>
            <div class="col-md-4 skin skin-square">
                <div class="form-group">
                    <input type="radio" name="cr_bankrupt" id="cr_bankrupt[]" value="2" <?php if($cr_bankrupt=="2"){ echo "checked"; }?>>
                    <label for="cr_bankrupt">ถูกฟ้องล้มละลาย</label>
                </div>
            </div>
            <div class="col-md-4 skin skin-square">
                <div class="form-group">
                    <input type="radio" name="cr_bankrupt" id="cr_bankrupt[]" value="9" <?php if($cr_bankrupt=="9"){ echo "checked"; }?>>
    ...
    <div class="bs-callout-success callout-border-left callout-bordered callout-transparent mt-1 p-1">  
        ...
        <div class="row">
            <div class="col-md-4 skin skin-square">
                <div class="form-group">
                    <input type="radio" name="cr_md_bankrupt" id="cr_md_bankrupt[]" value="1" <?php if($cr_md_bankrupt=="1"){ echo "checked"; }?>>
                    <label for="cr_md_bankrupt">ไม่มี</label>
                </div>
            </div>
            <div class="col-md-4 skin skin-square">
                <div class="form-group">
                    <input type="radio" name="cr_md_bankrupt" id="cr_md_bankrupt[]" value="2" <?php if($cr_md_bankrupt=="2"){ echo "checked"; }?>>
                    <label for="cr_md_bankrupt">มี ระบุชื่อ:</label>
                </div>
            </div>
            <div class="col-md-4 skin skin-square">
                    <div class="form-group">
                    <input type="radio" name="cr_md_bankrupt" id="cr_md_bankrupt[]" value="9" <?php if($cr_md_bankrupt=="9"){ echo "checked"; }?>>
