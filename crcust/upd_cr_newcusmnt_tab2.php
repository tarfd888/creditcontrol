    ...
    <fieldset>
       <!--  <h6 class="form-section text-info"><i class="fa fa-picture-o"></i>
        ...
        <div class="row mt-1">
            ...
            <?php if (inlist($user_role,"Action_View1") || inlist($user_role,"Action_View2") || inlist($user_role,"FinCR Mgr")) { ?>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6 showremark" style="display:none">
                    <div class="form-group">
                        <label for="cr_rem_revise">หมายเหตุแก้ไข :</label>
                        <textarea name="cr_rem_revise" id="cr_rem_revise"
                            class="form-control textarea-maxlength input-sm font-small-2 border-info"
                            placeholder="Enter upto 500 characters.." maxlength="500" rows="9"
                            style="line-height:1.5rem;"><?php echo $cr_rem_revise; ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-3 skin skin-square">
                    <div class="form-group chk_btn_submit">
                        <input type="radio" name="cr_status" id="cr_status1" value="A" <?php if($cr_status=="A"){ echo "checked"; }?>>
                        <label for="cr_status">เห็นควรอนุมัติ</label>
                    </div>
                    
                </div>
                <div class="col-md-3 skin skin-square">
                    <div class="form-group chk_btn_submit">
                        <input type="radio" name="cr_status" id="cr_status2" value="R" <?php if($cr_status=="R"){ echo "checked"; }?>>
                        <label for="cr_status">แก้ไข</label>
                    </div>
                </div>
                <?php } ?>
                <?php if (inlist($user_role,"FinCR Mgr")) { ?>
                    <input type="hidden" name="cr_status" id="cr_status1" value="<?php echo $cr_status?>">
                <?php } ?>    
            ...
            <?php if (inlist($user_role,'FinCR Mgr')) { ?>
                ...
                <div class="col-md-6"></div> 
                    <div class="col-md-3 skin skin-square">
                        <div class="form-group">
                            <input type="radio" name="cr_mgr_status" id="cr_mgr_status1" value="A" <?php if($cr_mgr_status=="A"){ echo "checked"; }?>>
                    ...
                    <div class="col-md-3 skin skin-square">
                        <div class="form-group">
                            <input type="radio" name="cr_mgr_status" id="cr_mgr_status2" value="R" <?php if($cr_mgr_status=="R"){ echo "checked"; }?>>
                            <label for="cr_mgr_status">ไม่เห็นควรอนุมัติ</label>
                        </div>
                    </div>
            <?php } ?>
            <?php if (!inlist($user_role,"FinCR Mgr")) { ?>
                    <input type="hidden" name="cr_mgr_remark" id="cr_mgr_remark" value="<?php echo $cr_mgr_remark?>">
                    <input type="hidden" name="cr_mgr_status" id="cr_mgr_status" value="<?php echo $cr_mgr_status?>">
                <?php } ?>    
        </div>
    </fieldset>
