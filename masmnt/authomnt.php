...
$curdate = date('Ymd');
$params = array();
$query_data = "SELECT * FROM author_mstr";
...
if($action_tiles == "1" || $gr == "1"){
	$Tiles = "Tiles"; $action_tiles = "1";
} else {
	$Tiles = "Geoluxe"; $action_tiles = "2";
}
if($gr == "1"){
	$action_tiles = "1";
} else if($gr =="2") {
	...
	<body class="vertical-layout vertical-menu 2-columns menu-collapsed  fixed-navbar" data-open="hover" data-menu="vertical-menu" data-col="2-columns">
						...
						<div class="row breadcrumbs-top d-inline-block">
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active"><font color="40ADF4">อำนาจดำเนินการอนุมัติ ลูกค้าทั่วไป ( <?php echo ($Tiles); ?> ) </font></li>
								</ol>
							</div>
						</div>
					</div>
									...
									<div class="card-header " >
										...
										<div class="heading-elements">
											<ul class="list-inline mb-0">
												<li><a href='#div_frm_autho_add' data-toggle='modal'><i class="fa fa-plus"></i> Add</a></li>
									...
									<div class="card-content collapse show">
										<div class="card-body ">
											<div class="table-responsive">
												<!-- Project All -->
												<table id="term_list" class="table table-sm table-hover table-bordered compact nowrap" style="width:100%; font-size:0.9em;">
		...
		<script type="text/javascript" language="javascript" class="init">
			$(document).ready(function() {
				...
				$('#term_list').DataTable({
					"ajax": {
					url: "../serverside/autho_list.php?author_nbr=<?php echo encrypt($action_tiles, $key); ?>",
					type: "post",
					error: function() {
				...
				"columnDefs": [{
					...
					//Nilubonp : Create Action Button
					{
						...
						"render": function(data, type, row, meta) {
							return 	'<a data-toggle="modal" class="open-EditDialog" data-author_id ="' + row.author_id + '" data-author_group ="' + row.author_group + '"  data-author_sign_nme ="' + row.author_sign_nme + '" data-author_code ="' + row.author_code + '" data-author_sign ="' + row.author_sign + '" data-author_email="' + row.author_email + '" data-author_text="' + row.author_text + '" data-author_salutation="' + row.author_salutation + '" data-author_email_status="' + row.author_email_status + '" data-financial_amt_beg="' + row.financial_amt_beg + '" data-financial_amt_end="' + row.financial_amt_end + '" data-author_active="' + row.author_active + '" data-author_remark="' + row.author_remark + '"  data-target="#div_frm_autho_edit" href="javascript:void(0)" ><i class="fa fa-pencil-square-o"></i></a>';
						}
					}
				],
		...
		$(document).on("click", "#btn-save", function(e) {
            ...
            var errortxt = "";
				...
				$.ajax({
					...
					type: 'POST',
					url: '../serverside/authormntpost.php?action_tiles=<?php echo encrypt($action_tiles, $key); ?>',
			...
			$(document).on("click", ".open-EditDialog", function() {
				...
				let author_remark = $(this).data('author_remark');
				...
				$("#div_frm_autho_edit .modal-body #author_remark").val(author_remark);
				...
				//$("#div_frm_autho_edit .modal-body #author_code").children("option[value=" + author_code + "]").attr("selected", true);
				//$("#div_frm_autho_edit .modal-body #author_text").children("option[value=" + author_text + "]").attr("selected", true);
			});
