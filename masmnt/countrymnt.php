...
<head>
    ...
    <title><?php echo(TITLE) ?><?php echo($countrytitle) ?></title>
...
<body class="vertical-layout vertical-menu 2-columns menu-collapsed  fixed-navbar" data-open="hover"
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">
                                    <font color="40ADF4">Country Master</font>
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-header ">
                                    ...
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                            <li><a href='#div_frm_country_add' data-toggle='modal'><i class="fa fa-plus"></i> Add Country</a></li>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body ">
                                        <div class="table-responsive">
                                            ...
                                            <form name="frm_del_country" id="frm_del_country">
                                                <input type="hidden" name="action" value="country_del">
    ...
    $(document).ready(function() {
        ...
        $('#country').DataTable({
            "ajax": {
                url: "../serverside/countrymstr_list.php",
                type: "post",
                error: function() {
            ...
            "columnDefs": [{
...

                {
                    ...
                    "render": function(data, type, row, meta) {
                        return '<a data-toggle="modal" class="open-EditDialog" data-country_code ="' +
                            row.country_code + '" data-country_desc ="' + row.country_desc +
                            '" data-term_active="' + row.term_active +
                            '" data-target="#div_frm_country_edit" href="javascript:void(0)" ><i class="fa fa-pencil-square-o"></i></a>| <a id="btdel" data-country_code=" ' + row.country_code + '" data-country_desc=" ' + row.country_desc + '" href="javascript:void(0)"><i class="fa fa-trash-o fa-sm "></i></a>';
                    }
                }
            ],
    ...
    $(document).on("click", ".open-EditDialog", function() {
        ...
        var country_desc = $(this).data('country_desc');

        $("#div_frm_country_edit .modal-body #country_code").val(country_code);
        $("#div_frm_country_edit .modal-body #country_desc").val(country_desc);
    ...
    $(document).on('click', '#btdel', function(e) {
        ...
        Swal.fire({
            title: "Are you sure?",
            html: "คุณต้องการลบชื่อ " +<?echo country_desc ; ?> + "  นี้ใช่หรือไหม่ !!!! ",
            type: "warning",
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    document.frm_del_country.country_code.value = country_code;
                    $.ajax({
                        beforeSend: function() {
                        ...
                        type: 'POST',
                        url: '../serverside/countrymstrpost.php',
                        data: $('#frm_del_country').serialize(),
                        timeout: 50000,
                        ...
                        success: function(result) {
                            ...
                            if (json.r == '0') {
                                ...
                                $(location).attr('href', 'countrymnt.php?q='+json.nb)
                            }
                        },
                        complete: function() {
    ...
    function countrypostform(formid) {
        $(document).ready(function() {
            $.ajax({
                beforeSend: function() {
                    $('body').append(
                ...
                success: function(result) {
                    ...
                    if (json.r == '0') {
                        ...
                        location.reload(true);
                        $(location).attr('href', '../masmnt/countrymnt.php?q=' + json.nb +
                            '&pg=' + json.pg)
                    }
                },
