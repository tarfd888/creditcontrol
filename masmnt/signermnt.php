	...
	<body class="vertical-layout vertical-menu 2-columns menu-collapsed  fixed-navbar" data-open="hover" data-menu="vertical-menu" data-col="2-columns">
									...
									<div class="card-content collapse show">
										<div class="card-body ">
											<div class="table-responsive">
												...
												<form name="frm_del_role" id="frm_del_role" action="../serverside/rolemstrpost.php">
		...
		<script type="text/javascript" language="javascript" class="init">
			$(document).ready(function() {
						...
						preConfirm: function() {
							return new Promise(function(resolve) {
								...
								$.ajax({
									...
									type: 'POST',
									url: '../serverside/rolemstrpost.php',
									...
									success: function(result) {
										...
										if (json.r == '0') {
											...
											$(location).attr('href', 'rolemstrmnt.php?rolenumber='+json.nb+'&pg='+json.pg)
										}
									},
									complete: function() {
				...
				$('#role_list').DataTable({
					"ajax": {
						url: "../serverside/signer_list.php",
