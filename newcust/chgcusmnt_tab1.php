    ...
    <div class="row skin skin-square">
        <div class="col-md-6">
            <div class="form-group">
                <input type="radio" name="cus_tg_cust" id="chg_cus_tg_cust1" value="dom">
                <label for="chg_cus_tg_cust1">ลูกค้าในประเทศ (Domestic)</label>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <input type="radio" name="cus_tg_cust" id="chg_cus_tg_cust2" value="exp">
                <label for="chg_cus_tg_cust2">ลูกค้าต่างประเทศ (Export)</label>
            </div>
        </div>
    </div>

    <!-- แต่งตั้งร้านสาขา (นิติบุคคลเดิม) -->
    <div class="newbranch_ch bs-callout-success callout-border-right callout-bordered callout-transparent p-1"
        style="display:none">
        <div class="row skin skin-square newbranch_ch" style="display:none">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select data-placeholder="เลือกประเภทลูกค้า"
                        class="form-control input-sm border-info font-small-2 select2" id="ch_form_cus"
                        name="ch_form_cus">
            ...
            <div class="col-md-3 dis_beg_date" style="display:none;">
                <div class="form-group">
                    <label for="cus_effective_date">เริ่มวันที่เริ่มใช้ : <font
                            class="text text-danger font-weight-bold">***
                        </font></label>
                    <input type="text" class="form-control input-sm font-small-2" id="cus_effective_date"
                        name="cus_effective_date">
                </div>
            </div>

            <!-- กรณีเปลี่ยนแปลงชื่อลูกค้าใหม่ -->
            <div class="col-md-3 dis_reg_nme" style="display:none;">
                <div class="form-group">
                    <label for="cus_reg_nme">ชื่อจดทะเบียน (ใหม่) :</label>
                    <font class="text text-danger font-weight-bold">***
                    </font>
                    <input type="text" class="form-control input-sm font-small-2 always-show-maxlength" id="cus_reg_nme"
        ...
        <!-- ข้อมูลทั่วไป -->
        <div class="row dis_ch_step1" style="display:none;">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="cust_code">รหัสลูกค้า</label>
                    <input type="text" class="form-control input-sm font-small-2" id="cust_code" name="cust_code">
                </div>
            </div>

            <!-- กรณีเปลี่ยนแปลงที่อยู่ใหม่ -->
            <div class="col-md-6 dis_reg_addr" style="display:none;">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6 dis_ch_step1" style="display:none;">
                <div class="form-group last">
                    <label for="cus_mas_addr">ที่อยู่จดทะเบียน (Registered Address) :</label>
                    <textarea name="cus_mas_addr" id="cus_mas_addr"
                        class="form-control textarea-maxlength input-sm font-small-2 border-info" placeholder=""
                        maxlength="500" rows="4" style="line-height:1.5rem;" readonly></textarea>
                </div>
            </div>
            <input type="hidden" class="form-control input-sm font-small-2" id="cus_code_mas" name="cus_code_mas">
            <!-- <input type="hidden" class="form-control input-sm font-small-2" id="cus_code" name="cus_code">  -->
            <input type="hidden" class="form-control input-sm font-small-2" id="cus_tax_id" name="cus_tax_id">
            <input type="hidden" class="form-control input-sm font-small-2" id="cus_branch" name="cus_branch">
        </div>
    </div>

    <div class="bs-callout-success callout-border-left callout-bordered callout-transparent mt-1 p-1 dis_ch_step1" style="display:none;">
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group input-group-sm mb-1">
                    ...
                    <input name="cusd_is_sale2_name" id="cusd_is_sale2_name" value="<?php echo $cusd_is_sale2_name ?>"
                        ...
                        data-ret_type_02="html" data-ret_field_03="cusd_is_sale2" data-ret_value_03="emp_scg_emp_id"
                        data-ret_type_03="html" class="form-control input-sm font-small-2 typeahead">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group input-group-sm mb-1">
                    ...
                    <input name="cusd_os_sale_name" id="cusd_os_sale_name" value="<?php echo $cusd_os_sale_name ?>"
                        ...
                        data-ret_type_04="html" class="form-control input-sm font-small-2 typeahead">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <a id="buthelp" data-id_field_code="cusd_os_sale_name"
                                data-id_field_name="cusd_os_sale_email" data-id_field_code1="cusd_os_sale"
                                data-id_field_mgr="cusd_os_sale_mgr" data-modal_class="modal-dialog modal-lg"
