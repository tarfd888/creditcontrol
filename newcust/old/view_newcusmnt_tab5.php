                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-1">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input name="cusd_review1_name" id="cusd_review1_name" value="<?php echo $cusd_review1_name ?>"
                                            ...
                                            class="form-control input-sm font-small-2 typeahead" readonly>
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <a id="_buthelp" data-id_field_code="cusd_review1_name"
                                ...
                                <div class="col-md-12 mb-1" style="display:<?php echo $dis_apprv ?>">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <a id="_buthelp" data-id_field_code="cusd_review2_name"
                                ...
                                <div class="col-md-12 mb-1" style="display:<?php echo $dis_apprv ?>">
                                    ...
                                    <input type="hidden" class="form-control input-sm font-small-2" id="sysc_cmo_id"
                                        name="sysc_cmo_id" value="<?php echo $cusd_review3 ?>">    
                                    <input type="text" class="form-control input-sm font-small-2" id="cusd_review3"
                                        name="cusd_review3" value="<?php echo $cusd_review3_name ?>" readonly>
                                </div>
                                ...
                                <div class="col-md-12 mb-1" style="display:<?php echo $dis_apprv ?>">
                                    ...
                                    <input type="hidden" class="form-control input-sm font-small-2" id="sysc_cfo_id"
                                        name="sysc_cfo_id" value="<?php echo $cusd_review4 ?>">    
                                    <input type="text" class="form-control input-sm font-small-2" id="cusd_review4"
                                        name="cusd_review4" value="<?php echo $cusd_review4_name; ?>" readonly>
                                </div>
                                <!--  <div class="col-md-6 mb-1">
                                                                        <label for="decisions2">ตำแหน่ง :</label>
                                                                        <input type="email"
                                ...
                                <div class="col-md-12 mb-1" style="display:<?php echo $dis_apprv ?>">
                                    ...
                                    <input type="hidden" class="form-control input-sm font-small-2" id="sysc_md_id"
                                        name="sysc_md_id" value="<?php echo $cusd_approve_fin ?>">
                                    <input type="text" class="form-control input-sm font-small-2" id="cusd_approve_fin"
                                        name="cusd_approve_fin" value="<?php echo $cusd_approve_fin_name; ?>" readonly>
                                </div>
                                <!--  <div class="col-md-6 mb-1">
                                                                        <label for="decisions2">ตำแหน่ง :</label>
                                                                        <input type="email"
