            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="cusd_test">เหตุผลในการเปลี่ยนแปลง / ยกเลิก (ใช้สำหรับเสนอขออนุมัติ):</label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-1">
                                <label class="label-control">ผู้พิจารณา 1 <?php echo $viewer1 ?>
                                    :</label>
                            ...
                            <!-- ผู้พิจารณา 2 -->
                            <div class="col-md-12 mb-1 dis_apprv" style="display:<?php echo $dis_apprv ?>">
