<fieldset>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select data-placeholder="Select a doc type ..."
                        class="form-control input-sm border-info font-small-2 select2" id="cus_term_dom"
                        name="cus_term_dom" style="display:<?php echo $dom_show; ?>">
                        ...
                        <?php
                                                                    ...
                                                                    ?>
                        <option value="<?php echo $r_doc['term_code']; ?>" data-icon="fa fa-wordpress" <?php if ($cus_term == $r_doc['term_code']) {
                                            echo "selected";
                                        } ?>>
                    ...
                    <!-- case term export -->
                    <select data-placeholder="Select a doc type ..."
                        class="cus_term_exp form-control input-sm border-info font-small-2 select2" id="cus_term_exp"
                        name="cus_term_exp" style="display:<?php echo $exp_show; ?>">
                        <option value="" selected>--- เลือกเงื่อนไขการชำระเงิน ---
                        </option>
                        <?php
                ...
                <div class="form-group">
                    ...
                    <select data-placeholder="Select a doc type ..."
                        ...
                        <?php
                                    ...
                                    while ($r_doc = sqlsrv_fetch_array($result_doc, SQLSRV_FETCH_ASSOC)) {
                                    ?>
                        <option value="<?php echo $r_doc['bank_code']; ?>" data-icon="fa fa-wordpress" <?php if ($cus_bg1 == $r_doc['bank_code']) {
                                            echo "selected";
                                        } ?>>
                ...
                <div class="form-group">
                    ...
                    <select data-placeholder="Select a doc type ..."
                        ...
                        <?php
                                    ...
                                    while ($r_doc = sqlsrv_fetch_array($result_doc, SQLSRV_FETCH_ASSOC)) {
                                    ?>
                        <option value="<?php echo $r_doc['bank_code']; ?>" data-icon="fa fa-wordpress" <?php if ($cus_bg2 == $r_doc['bank_code']) {
                                            echo "selected";
                                        } ?>>
                            <?php echo $r_doc['bank_code']." | ".$r_doc['bank_th_name']; ?>
                        </option>
    ...
    <div class="bs-callout-success callout-border-left callout-bordered callout-transparent mt-1 p-1">      
        ...
        <div class="row skin skin-square comNtxPage2">
            ...
            <div class="col-md-4 cus_cond_term_txt" style="display:<?php echo $cus_cond_term_txt ?>;">
                <div class="form-group">
                    <input type="text" class="form-control input-sm font-small-2" id="cus_cond_term_oth" name="cus_cond_term_oth"
                        value="<?php echo $cus_cond_term_oth ?>">
                </div>
            </div>
        </div>
    
        <div class="row dis_step2" style="display:show;">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control always-show-maxlength input-sm font-small-2" id="cus_pay_addr"
                        name="cus_pay_addr" maxlength="255" value="<?php echo $cus_pay_addr;?>">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control always-show-maxlength input-sm font-small-2"
                        id="cus_contact_nme_pay" name="cus_contact_nme_pay" maxlength="255" value="<?php echo $cus_contact_nme_pay;?>">
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control always-show-maxlength input-sm font-small-2" id="cus_contact_tel"
                        name="cus_contact_tel" maxlength="20" value="<?php echo $cus_contact_tel;?>">
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control always-show-maxlength input-sm font-small-2" id="cus_contact_fax"
                        name="cus_contact_fax" maxlength="20" value="<?php echo $cus_contact_fax;?>">
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control always-show-maxlength input-sm font-small-2 email-inputmask" id="cus_contact_email"
                        name="cus_contact_email" maxlength="50" value="<?php echo $cus_contact_email;?>">
                </div>
            </div>
        </div>
