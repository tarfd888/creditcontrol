...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"../serverside/upload_img_list.php?qimage=<?php echo $temimagerandom; ?>",
   method:"POST",
 ...
 $(document).on('click', '.delete', function(){
  ...
  if(confirm("Are you sure you want to remove it?"+image_id))
  {
   $.ajax({
    url:"../serverside/upload_img_post.php",
    method:"POST",
 ...
 $('#edit_image_form').on('submit', function(event){
  ...
  {
   $.ajax({
    url:"../serverside/update_image.php",
    method:"POST",
