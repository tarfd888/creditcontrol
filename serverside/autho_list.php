		...
		if($row_counts == 0) // Result == 0 row
		...
		else // :  Result > 0 row
			{
				...
				while($row_autho_list = sqlsrv_fetch_array($result_autho_list, SQLSRV_FETCH_ASSOC))
				{
						...
						$dataArray_autho_list['author_position'] = html_escape($row_autho_list['author_position']);
						...
						$dataArray_autho_list['author_remark'] = html_escape($row_autho_list['author_remark']);
