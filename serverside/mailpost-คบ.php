<?php
	...
	if($crstm_cus_active=="1") { // เช็คลูกค้าเก่าหรือไม่
		if($crstm_chk_rdo2=="C1"){ // ขอเพิ่มวงเงิน
			...
			$txt_cc = "<span style='color:Blue'><br>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;เพื่อโปรดพิจารณาให้ความเห็นชอบก่อนนำเสนอ คบ.  เพื่อพิจารณาอนุมัติปรับเพิ่มวงเงิน ให้ $crstm_cus_name จาก ".number_format($tot_cc )." บาท   เป็น ".number_format($gr_tot)."  บาท <br></span> ";																															
	...
	"$txt_cc" .
	"$txt_term <br>".
	"ตามอำนาจดำเนินการ :  $crstm_approve <br>".
	"เหตุผลที่เสนอขอวงเงิน<br>".
	"&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;$crstm_sd_reson <br>".
	"ความเห็นสินเชื่อ เห็นควรอนุมัติ <br><br>".
	"&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;$crstm_cc1_reson <br>".
	"&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;$crstm_cc2_reson <br>".
	"&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;Finance & Credit Manager :$crstm_mgr_reson <br>".
