                ...
                <div class="row p-1">
                    <div class="col-lg-12">
                        ...
                        <div class="row pr-1 pl-1 ">
                            ...
                            <div class="col-lg-7 pt-1 border-bottom" style="text-align:right"><? echo $cus_cr_limit1; ?>&nbsp;บาท</div>
                        </div>
                        <?php if($cus_cr_limit2!="") { ?>
                            <div class="row pr-1 pl-1 ">
                                <div class="col-lg-5 col-md-6 pt-1 ">วงเงิน :</div>
                                <div class="col-lg-7 pt-1 border-bottom" style="text-align:right"><? echo $cus_cr_limit2; ?>&nbsp;บาท</div>
                            </div>
                        <?php } ?>	
                    </div>
                </div>
